...
export const en: TaskboardDict = {
  ...
  'board.newmenu.categoryEmpty': 'No templates in the current category; adjust the category in Board Settings',
  ...
  'detail.action.sourceToggle': 'Source / rendered toggle',
  'detail.action.rawTitle': 'Switch to source to inspect the Markdown markup',
  'detail.action.raw': 'Source',
  'detail.action.renderTitle': 'Switch back to the rendered Markdown preview',
  'detail.action.render': 'Rendered',
  'detail.action.fullscreenEnter': 'Fill the current board area with the detail pane',
  'detail.action.fullscreenExit': 'Exit detail fullscreen (Esc)',
  'detail.action.fullscreenEnterLabel': '⛶ Fullscreen',
  'detail.action.fullscreenExitLabel': '⛶ Exit fullscreen',
  'detail.chip.speedFast': '⚡ Fast',
  'detail.chip.capabilities': 'Capabilities · {names}',
  'detail.file.open': 'Open',
  'detail.file.unavailable': 'Unavailable',
  'detail.file.unavailableReason.outside': 'Outside the current session workspace — not openable yet',
  'detail.file.unavailableReason.noCwd': 'Current session path is not ready',
  'detail.file.unavailableReason.unresolved': 'Cannot resolve the file path',
  'detail.file.openTitle': 'Open file {path}',
  ...
  'form.field.speed': 'Speed mode',
  'form.field.speedTitle': 'Requests a lower-latency path from the execution adapter; available only when the model provider supports it',
  'form.speed.standard': 'Standard',
  'form.speed.standardHint': 'Standard request path',
  'form.speed.fast': 'Fast',
  'form.speed.fastHint': 'Requests a lower-latency path from the execution adapter',
  'form.field.capabilities': 'Execution capabilities',
  'form.capabilities.hint': 'Selections are granted only while this task executes or is claimed by a session; other sessions are unaffected.',
  'form.capabilities.fullWarn': 'Full file access plus browser/computer operation would be authorized together — only select for trusted tasks.',
  ...
  'tpl.updated': 'Template updated',
  'tpl.category.aria': 'Template category {name}',
  'tpl.categoryEmpty': 'No templates in the category selected in Board Settings; adjust the category there',
  'tpl.save.button': 'Save name & category',
  'tpl.category.placeholder': 'Type or choose a category…',
  'tpl.speedFast': 'Fast',
  ...
  'form.perm.fullWarn': 'Full access disables approvals and allows unrestricted file changes — only use for trusted tasks.',
  ...
  'set.category.heading': 'Template category in the “+ New task” menu',
  'set.category.all': 'All categories ({count})',
  'set.category.empty': 'no templates yet',
  'set.category.hint': 'Only filters the templates shown in the “+ New task” menu; template content and existing tasks are unaffected. Categories are managed in “Manage templates”.',
  ...
  // ── host-generated system comments (localized at render) ────────────
