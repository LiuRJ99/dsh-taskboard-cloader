...
export const zh = {
  ...
  'board.newmenu.categoryEmpty': '当前分类暂无模板，请在看板设置中调整模板分类',
  ...
  'detail.action.sourceToggle': '原文 / 渲染切换',
  'detail.action.rawTitle': '切换为原文，查看 Markdown 标记',
  'detail.action.raw': '原文',
  'detail.action.renderTitle': '切换为 Markdown 渲染预览',
  'detail.action.render': '渲染',
  'detail.action.fullscreenEnter': '让详情占满当前看板区域',
  'detail.action.fullscreenExit': '退出详情全屏（Esc）',
  'detail.action.fullscreenEnterLabel': '⛶ 全屏',
  'detail.action.fullscreenExitLabel': '⛶ 退出全屏',
  'detail.chip.speedFast': '⚡ 快速',
  'detail.chip.capabilities': '能力 · {names}',
  'detail.file.open': '打开',
  'detail.file.unavailable': '不可访问',
  'detail.file.unavailableReason.outside': '当前会话 workspace 外，暂不可打开',
  'detail.file.unavailableReason.noCwd': '当前会话路径尚未就绪',
  'detail.file.unavailableReason.unresolved': '无法解析文件路径',
  'detail.file.openTitle': '打开文件 {path}',
  ...
  'form.field.speed': '速度模式',
  'form.field.speedTitle': '向执行适配器请求更低延迟路径；仅当模型提供方支持时可选',
  'form.speed.standard': '标准',
  'form.speed.standardHint': '标准请求路径',
  'form.speed.fast': '快速',
  'form.speed.fastHint': '向执行适配器请求更低延迟路径',
  'form.field.capabilities': '执行能力',
  'form.capabilities.hint': '勾选项只在该任务执行或被会话认领时授权，不会改变其他会话。',
  'form.capabilities.fullWarn': '高权限文件访问与浏览器/电脑操作会一起授权，请确认任务来源可信。',
  ...
  'tpl.renamed': '模板已改名',
  'tpl.updated': '模板已更新',
  'tpl.category.aria': '模板类别 {name}',
  'tpl.categoryEmpty': '当前看板设置的类别暂无模板，请在看板设置中调整模板分类',
  'tpl.save.button': '保存名称与类别',
  'tpl.category.placeholder': '输入或选择类别…',
  'tpl.speedFast': '快速',
  ...
  'form.perm.fullWarn': '完全权限将关闭审批并允许不受限制的文件修改，请确认任务可信。',
  ...
  'set.category.heading': '新建任务菜单的模板分类',
  'set.category.all': '全部分类（{count}）',
  'set.category.empty': '当前无模板',
  'set.category.hint': '只影响“+ 新建任务”菜单的模板展示，不会影响模板内容和已有任务；模板类别可在“管理模板”中调整。',
  'card.badge.permReadOnly': '🔒 仅查看',
  'card.badge.permReadOnlyTitle': '权限：仅可查看',
  'card.badge.permFull': '⚡ 全权限',
  'card.badge.permFullTitle': '权限：完全权限',
  'card.badge.speedFast': '快速',
  ...
  // ── host-generated system comments（渲染时本地化）────────────────────
