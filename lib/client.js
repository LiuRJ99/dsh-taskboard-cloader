	...
	factory: (require) => {
		...
		*/
		function TaskFormModal({ controller, task }) {
			...
			const [speed, setSpeed] = (0, react.useState)(task?.speed ?? (prefill?.speed === "fast" ? "fast" : "standard"));
			...
			const reasoning = (selectedModel === void 0 ? void 0 : catalog.find((entry) => entry.provider === selectedModel.provider && entry.model === selectedModel.model))?.reasoning;
