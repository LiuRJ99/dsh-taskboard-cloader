window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		function speedForModel(hasModel, speed) {
		...
		*/
		function TaskFormModal({ controller, task }) {
			...
			const [speed, setSpeed] = (0, react.useState)(initialModel !== void 0 && (task?.speed === "fast" || prefill?.speed === "fast") ? "fast" : "standard");
			...
			const hasSelectedModel = selectedModel !== void 0;
					...
					children: [
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								hasSelectedModel && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Field, {
									label: "速度模式",
									children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("select", {
