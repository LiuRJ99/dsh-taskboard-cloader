...
function Markdown({ text, className }) {
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		className: ["dsh-atb-md", className].filter(Boolean).join(" "),
...
function FileActions({ target, onOpenFile, onReferenceFile }) {
	if (onOpenFile === void 0 && onReferenceFile === void 0) return null;
	if (target === void 0 || !target.available) {
		const reason = target?.reason === "outside-session-workspace" ? "当前会话 workspace 外，暂不可打开或引用" : target?.reason === "missing-session-cwd" ? "当前会话路径尚未就绪" : "无法解析文件路径";
		return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
			className: "dsh-atb-file-actions",
			onClick: (event) => event.stopPropagation(),
			children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
				className: "dsh-atb-file-unavailable",
				title: target?.path ?? reason,
				children: "不可访问"
			}), target !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
				type: "button",
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
		...
		children: [
			...
			onOpenFile !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
				type: "button",
				className: "dsh-atb-file-action",
				onClick: () => onOpenFile(target.path),
				children: "打开"
			}),
			onReferenceFile !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
				type: "button",
				className: "dsh-atb-file-action",
				onClick: () => onReferenceFile(target.path),
				children: "引用"
			})
		]
	});
...
function ReportFileRow({ raw, task, execution, workspaces, scope, assumePath, onOpenFile, onReferenceFile }) {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
		...
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("code", {
			...
			children: raw
		}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(FileActions, {
			target,
			onOpenFile,
			onReferenceFile
		})]
...
*/
function PreviewText({ text, className, raw }) {
...
*/
function ReportBlock({ task, raw, workspaces, scope, onOpenFile, onReferenceFile }) {
...
*/
function IsolationBlock({ task, controller, workspaces, scope, onOpenFile, onReferenceFile }) {
...
* @param now - current epoch ms (stale-claim highlight).
*/
function TaskDetail({ task, controller, now, fullScreen = false, onToggleFullScreen, scope, onReferenceFile, onOpenFile }) {
...
*/
function TaskBoard({ controller, scope, visible, onReferenceFile, onOpenFile }) {
...
function registerBetterSidebarTab(ctx, controller) {
	...
	const descriptor = {
		...
		component: ({ ctx: sidebarCtx, scope, visible, onReferenceFile }) => {
