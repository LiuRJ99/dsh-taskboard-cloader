...
* `installModelSelection`: pin one agent context to a provider/model pair via
* two hooks. Pure (no private symbols, no module state), so a
* structure-compatible copy is exact — and it keeps the host half free of any
* runtime @deepseek-ai import, which the host build externalizes and the
* profile therefore never resolves.
*/
...
//#endregion
export { MessageId, defineTool, dshHomePath, installModelSelection };
