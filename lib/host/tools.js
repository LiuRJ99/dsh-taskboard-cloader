...
function taskLine(t) {
	...
	if (t.permissionMode !== void 0) parts.push(`·权限 ${t.permissionMode}`);
...
function taskDetail(t) {
	...
	if (t.permissionMode !== void 0) lines.push(`权限模式: ${t.permissionMode}`);
	...
	disposers.push(register(defineTool({
		...
		async execute(args, exec) {
			try {
				...
				const permissionMode = args.permissionMode === void 0 ? void 0 : asPermissionMode(args.permissionMode);
