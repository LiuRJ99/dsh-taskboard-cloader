...
function taskDetail(t) {
	...
	if (t.model !== void 0) lines.push(`固定模型: ${t.model.provider}/${t.model.model}${t.model.reasoningEffort !== void 0 ? ` · 推理等级 ${t.model.reasoningEffort}` : ""}`);
		...
		parameters: {
			...
			model: {
				...
				properties: {
					...
					reasoningEffort: {
						type: "string",
						description: "Adapter-owned reasoning effort id; omit for the model/provider default."
					},
					model: {
						type: "string",
