...
import { TASKBOARD_SKILL } from "./host/skill.js";
import { listSkillsForView } from "./host/skill-view.js";
import { createGitFace } from "./host/git.js";
import { createRepoScanner } from "./host/repos.js";
import { dshHomePath, installModelSelection } from "./host/sdk.js";
...
function lazyGateService(ctx) {
	return ctx.get(TOOL_LAZY_GATE_SERVICE);
}
...
function apply(ctx) {
	...
	if (skills?.register !== void 0) ctx.effect(() => skills.register(TASKBOARD_SKILL), "dsh-taskboard: taskboard skill");
				...
				disposeRoutes = registerTaskboardRoutes(webCtx, {
					...
					promptCompletions: async (view) => {
						try {
							...
							const rawSkills = skillsService?.list !== void 0 ? await listSkillsForView(skillsService, {
								presets: agentCtx.get("agentPresets"),
								workspaces: workspaceFace(wsCtx.workspaceRegistry),
